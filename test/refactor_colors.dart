...
void main() {
  ...
  for (final file in files) {
    ...
    final replacements = {
      'Colors.grey.shade100': 'AppColors.inputBackground',
      'Colors.grey.shade200': 'AppColors.border',
      'Colors.grey.shade300': 'AppColors.border',
      'Colors.grey.shade400': 'AppColors.textHint',
      ...
      'Colors.grey.shade800': 'AppColors.textPrimary',
      'Colors.grey[600]': 'AppColors.textSecondary',
      'Colors.grey': 'AppColors.textSecondary',
      'Colors.black.withOpacity(0.05)': 'AppColors.border',
      'Colors.black.withOpacity(0.1)': 'AppColors.border',
